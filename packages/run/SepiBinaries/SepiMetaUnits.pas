...
type
  ...
  private
    { TODO 2 -cMetaunités : Ajouter des champs concernant les directives de méthodes }
...
begin
  { TODO 2 -cMetaunités : Charger une unité par son nom (ce peut être une unité "système" ou non) }
end;
