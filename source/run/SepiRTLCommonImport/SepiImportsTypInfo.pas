...
begin
  ...
  with Result do
  begin
    AddField('OrdType', System.TypeInfo(TOrdType), '');
    AddField('MinValue', System.TypeInfo(Longint), 'OrdType');
    AddField('MaxValue', System.TypeInfo(Longint), 'MinValue');
    AddField('BaseType', 'PPTypeInfo', 'MaxValue');
    AddField('NameList', System.TypeInfo(ShortStringBase), 'BaseType');
    AddField('EnumUnitName', System.TypeInfo(ShortStringBase), 'NameList');
    AddField('CompType', 'PPTypeInfo', 'OrdType');
    AddField('FloatType', System.TypeInfo(TFloatType), '');
    AddField('MaxLength', System.TypeInfo(Byte), '');
    AddField('ClassType', 'TClass', '');
    AddField('ParentInfo', 'PPTypeInfo', 'ClassType');
    AddField('PropCount', System.TypeInfo(SmallInt), 'ParentInfo');
    AddField('UnitName', System.TypeInfo(ShortStringBase), 'PropCount');
    AddField('MethodKind', System.TypeInfo(TMethodKind), '');
    AddField('ParamCount', System.TypeInfo(Byte), 'MethodKind');
    AddField('ParamList', '$1', 'ParamCount');
    AddField('IntfParent', 'PPTypeInfo', '');
    AddField('IntfFlags', System.TypeInfo(TIntfFlagsBase), 'IntfParent');
    AddField('Guid', 'TGUID', 'IntfFlags');
    AddField('IntfUnit', System.TypeInfo(ShortStringBase), 'Guid');
    AddField('MinInt64Value', System.TypeInfo(Int64), '');
    AddField('MaxInt64Value', System.TypeInfo(Int64), True);
    AddField('elSize', System.TypeInfo(Longint), '');
    AddField('elType', 'PPTypeInfo', 'elSize');
    AddField('varType', System.TypeInfo(Integer), 'elType');
    AddField('elType2', 'PPTypeInfo', 'varType');
    AddField('DynUnitName', System.TypeInfo(ShortStringBase), 'elType2');
