...
begin
  ...
  TSepiConstant.Create(Result, 'SCantWriteResourceStreamError', SCantWriteResourceStreamError);
  TSepiConstant.Create(Result, 'SCharExpected', SCharExpected);
  TSepiConstant.Create(Result, 'SCheckSynchronizeError', SCheckSynchronizeError);
  TSepiConstant.Create(Result, 'SClassNotFound', SClassNotFound);
  TSepiConstant.Create(Result, 'SDelimiterQuoteCharError', SDelimiterQuoteCharError);
  ...
  TSepiConstant.Create(Result, 'SInvalidActionCreation', SInvalidActionCreation);
  TSepiConstant.Create(Result, 'SInvalidActionEnumeration', SInvalidActionEnumeration);
  TSepiConstant.Create(Result, 'SInvalidActionRegistration', SInvalidActionRegistration);
  TSepiConstant.Create(Result, 'SInvalidActionUnregistration', SInvalidActionUnregistration);
  ...
  TSepiConstant.Create(Result, 'SInvalidPropertyElement', SInvalidPropertyElement);
  ...
  TSepiConstant.Create(Result, 'SInvalidDayOfWeekInMonth', SInvalidDayOfWeekInMonth);
  ...
  TSepiConstant.Create(Result, 'SConvIncompatibleTypes2', SConvIncompatibleTypes2);
  TSepiConstant.Create(Result, 'SConvIncompatibleTypes3', SConvIncompatibleTypes3);
  TSepiConstant.Create(Result, 'SConvIncompatibleTypes4', SConvIncompatibleTypes4);
  ...
  TSepiConstant.Create(Result, 'SConvUnknownDescriptionWithPrefix', SConvUnknownDescriptionWithPrefix);
  ...
  TSepiConstant.Create(Result, 'SFailedToCallConstructor', SFailedToCallConstructor);
  ...
  TSepiConstant.Create(Result, 'sCantChangeWhileActive', sCantChangeWhileActive);
  ...
  TSepiConstant.Create(Result, 'SCmplxCouldNotParseImaginary', SCmplxCouldNotParseImaginary);
  TSepiConstant.Create(Result, 'SCmplxCouldNotParseSymbol', SCmplxCouldNotParseSymbol);
  TSepiConstant.Create(Result, 'SCmplxCouldNotParsePlus', SCmplxCouldNotParsePlus);
  TSepiConstant.Create(Result, 'SCmplxCouldNotParseReal', SCmplxCouldNotParseReal);
  ...
  TSepiConstant.Create(Result, 'SMicromicronsDescription', SMicromicronsDescription);
  TSepiConstant.Create(Result, 'SAngstromsDescription', SAngstromsDescription);
  TSepiConstant.Create(Result, 'SMillimicronsDescription', SMillimicronsDescription);
  TSepiConstant.Create(Result, 'SMicronsDescription', SMicronsDescription);
  TSepiConstant.Create(Result, 'SMillimetersDescription', SMillimetersDescription);
  TSepiConstant.Create(Result, 'SCentimetersDescription', SCentimetersDescription);
  TSepiConstant.Create(Result, 'SDecimetersDescription', SDecimetersDescription);
  TSepiConstant.Create(Result, 'SMetersDescription', SMetersDescription);
  TSepiConstant.Create(Result, 'SDecametersDescription', SDecametersDescription);
  TSepiConstant.Create(Result, 'SHectometersDescription', SHectometersDescription);
  TSepiConstant.Create(Result, 'SKilometersDescription', SKilometersDescription);
  TSepiConstant.Create(Result, 'SMegametersDescription', SMegametersDescription);
  TSepiConstant.Create(Result, 'SGigametersDescription', SGigametersDescription);
  ...
  TSepiConstant.Create(Result, 'SNauticalMilesDescription', SNauticalMilesDescription);
  TSepiConstant.Create(Result, 'SAstronomicalUnitsDescription', SAstronomicalUnitsDescription);
  TSepiConstant.Create(Result, 'SLightYearsDescription', SLightYearsDescription);
  ...
  TSepiConstant.Create(Result, 'SSquareMillimetersDescription', SSquareMillimetersDescription);
  TSepiConstant.Create(Result, 'SSquareCentimetersDescription', SSquareCentimetersDescription);
  TSepiConstant.Create(Result, 'SSquareDecimetersDescription', SSquareDecimetersDescription);
  TSepiConstant.Create(Result, 'SSquareMetersDescription', SSquareMetersDescription);
  TSepiConstant.Create(Result, 'SSquareDecametersDescription', SSquareDecametersDescription);
  TSepiConstant.Create(Result, 'SSquareHectometersDescription', SSquareHectometersDescription);
  TSepiConstant.Create(Result, 'SSquareKilometersDescription', SSquareKilometersDescription);
  TSepiConstant.Create(Result, 'SSquareInchesDescription', SSquareInchesDescription);
  TSepiConstant.Create(Result, 'SSquareFeetDescription', SSquareFeetDescription);
  TSepiConstant.Create(Result, 'SSquareYardsDescription', SSquareYardsDescription);
  TSepiConstant.Create(Result, 'SSquareMilesDescription', SSquareMilesDescription);
  ...
  TSepiConstant.Create(Result, 'SSquareRodsDescription', SSquareRodsDescription);
  TSepiConstant.Create(Result, 'SVolumeDescription', SVolumeDescription);
  TSepiConstant.Create(Result, 'SCubicMillimetersDescription', SCubicMillimetersDescription);
  TSepiConstant.Create(Result, 'SCubicCentimetersDescription', SCubicCentimetersDescription);
  TSepiConstant.Create(Result, 'SCubicDecimetersDescription', SCubicDecimetersDescription);
  TSepiConstant.Create(Result, 'SCubicMetersDescription', SCubicMetersDescription);
  TSepiConstant.Create(Result, 'SCubicDecametersDescription', SCubicDecametersDescription);
  TSepiConstant.Create(Result, 'SCubicHectometersDescription', SCubicHectometersDescription);
  TSepiConstant.Create(Result, 'SCubicKilometersDescription', SCubicKilometersDescription);
  TSepiConstant.Create(Result, 'SCubicInchesDescription', SCubicInchesDescription);
  TSepiConstant.Create(Result, 'SCubicFeetDescription', SCubicFeetDescription);
  TSepiConstant.Create(Result, 'SCubicYardsDescription', SCubicYardsDescription);
  TSepiConstant.Create(Result, 'SCubicMilesDescription', SCubicMilesDescription);
  TSepiConstant.Create(Result, 'SMilliLitersDescription', SMilliLitersDescription);
  TSepiConstant.Create(Result, 'SCentiLitersDescription', SCentiLitersDescription);
  TSepiConstant.Create(Result, 'SDeciLitersDescription', SDeciLitersDescription);
  TSepiConstant.Create(Result, 'SLitersDescription', SLitersDescription);
  TSepiConstant.Create(Result, 'SDecaLitersDescription', SDecaLitersDescription);
  TSepiConstant.Create(Result, 'SHectoLitersDescription', SHectoLitersDescription);
  TSepiConstant.Create(Result, 'SKiloLitersDescription', SKiloLitersDescription);
  TSepiConstant.Create(Result, 'SAcreFeetDescription', SAcreFeetDescription);
  TSepiConstant.Create(Result, 'SAcreInchesDescription', SAcreInchesDescription);
  ...
  TSepiConstant.Create(Result, 'SDecisteresDescription', SDecisteresDescription);
  TSepiConstant.Create(Result, 'SSteresDescription', SSteresDescription);
  TSepiConstant.Create(Result, 'SDecasteresDescription', SDecasteresDescription);
  TSepiConstant.Create(Result, 'SFluidGallonsDescription', SFluidGallonsDescription);
  TSepiConstant.Create(Result, 'SFluidQuartsDescription', SFluidQuartsDescription);
  TSepiConstant.Create(Result, 'SFluidPintsDescription', SFluidPintsDescription);
  TSepiConstant.Create(Result, 'SFluidCupsDescription', SFluidCupsDescription);
  TSepiConstant.Create(Result, 'SFluidGillsDescription', SFluidGillsDescription);
  TSepiConstant.Create(Result, 'SFluidOuncesDescription', SFluidOuncesDescription);
  TSepiConstant.Create(Result, 'SFluidTablespoonsDescription', SFluidTablespoonsDescription);
  TSepiConstant.Create(Result, 'SFluidTeaspoonsDescription', SFluidTeaspoonsDescription);
  TSepiConstant.Create(Result, 'SDryGallonsDescription', SDryGallonsDescription);
  ...
  TSepiConstant.Create(Result, 'SDryBucketsDescription', SDryBucketsDescription);
  TSepiConstant.Create(Result, 'SDryBushelsDescription', SDryBushelsDescription);
  ...
  TSepiConstant.Create(Result, 'SMicrogramsDescription', SMicrogramsDescription);
  TSepiConstant.Create(Result, 'SMilligramsDescription', SMilligramsDescription);
  TSepiConstant.Create(Result, 'SCentigramsDescription', SCentigramsDescription);
  ...
  TSepiConstant.Create(Result, 'SHectogramsDescription', SHectogramsDescription);
  TSepiConstant.Create(Result, 'SKilogramsDescription', SKilogramsDescription);
  TSepiConstant.Create(Result, 'SMetricTonsDescription', SMetricTonsDescription);
  ...
  TSepiConstant.Create(Result, 'STemperatureDescription', STemperatureDescription);
  ...
  TSepiConstant.Create(Result, 'SFahrenheitDescription', SFahrenheitDescription);
  ...
  TSepiConstant.Create(Result, 'SMilliSecondsDescription', SMilliSecondsDescription);
  ...
  TSepiConstant.Create(Result, 'SFortnightsDescription', SFortnightsDescription);
  ...
  TSepiConstant.Create(Result, 'SJulianDateDescription', SJulianDateDescription);
  TSepiConstant.Create(Result, 'SModifiedJulianDateDescription', SModifiedJulianDateDescription);
